...
var allNames = ["Top","Gem", "Season", "Piggy", "Welcome", "Package"]
...
function setColors(col){
    ...
    colors["Top"] = "#000000"
    colors["Gem"] = "#b8190b"
    colors["Season"] = "#f0e3a5"
    colors["Package"] = this.stringtoColor("Package")
    colors["Piggy"] = this.stringtoColor("Piggy")
    colors["Welcome"] = this.stringtoColor("Welcome")
}
