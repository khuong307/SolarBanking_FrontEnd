                            ...
                            <div className="card-body">
                                ...
                                <div className="col-lg-12 d-flex justify-content-center">
                                    <div className="col-lg-6">
                                        <p className="card-text" style={{ fontFamily: "Jost", fontSize: 15 }}><i className="fa fa-user mr-2"></i>Recipient: {infoDesAccount.full_name}</p>
                                        <p className="card-text" style={{ fontFamily: "Jost", fontSize: 15 }}><i className="fa fa-bank mr-2"></i>Bank: {currentBank ? currentBank.label : SOLAR_BANK}</p>
