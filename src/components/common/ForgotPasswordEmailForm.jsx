...
function ForgotPasswordEmailForm(){
    ...
    return (
        <div style={{backgroundImage: `url(/src/assets/img/background_login.png)`, backgroundSize: "cover", height: "100vh", width: "100vw"}}>
                    ...
                    <div className="auth-innerright">
                        <div className="authentication-box">
                            <div className="mt-2 mb-2">
                                <p className="forgot-password-label ml-4" style={{color: "white"}}>We'll send an OTP code to:</p>
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className="ml-1 mr-lg-5 d-flex justify-content-between align-content-center align-items-center">
                                        <button type="submit" className="btn btnLogin2 mt-3 send-email-btn">
                                            Send OTP code
                                            <i className="fa fa-arrow-right ml-2"></i>
                                        </button>
                                    </div>
                                    <div className="text-center back-link-wrapper">
                                        <Link className="back-link" to="/" style={{color: "white"}}>
                                            Back to login
                                        </Link>
                                    </div>
                                </form>
